...
magerun install --dbHost="localhost" --dbUser="dev" --dbPass="dev" --dbName="magento" --installSampleData=yes --useDefaultConfigParams=yes --magentoVersionByName="magento-mirror-1.9.3.2" --installationFolder="/opt/magento1" --baseUrl="http://192.168.33.10/magento1/"
